      ...
      <main className="px-4 py-8">
        ...
        >
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            >
              Expert in building scalable, high-performance applications with clean architecture and optimized UI/UX
            </motion.p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="glass-effect rounded-2xl p-8">
              <motion.p
                ...
                viewport={{ once: false }}
                transition={{ duration: 1.3, ease: "easeInOut" }}
                className="text-white   mb-6 text-xl font-semibold leading-10 text-justify "
              >
             I am a skilled developer with a strong foundation in software development, focusing on building efficient, scalable, and high-performance applications. I specialize in writing clean, maintainable code and leveraging modern frameworks and technologies to create seamless digital experiences. Passionate about solving complex problems, optimizing performance, and continuously improving my craft, I thrive on turning ideas into robust and innovative solutions.
              </motion.p>
              <div className="my-6 w-[100%] h-[1px] ">
